      ...
      <div className='main_login_page_div_admin'>
        <form className="form_main">
          <div className="logo-container">
            <img src={Logo} alt="Saburi Logo" className="login-logo" />
          </div>
          
          <p className="heading">Admin Portal</p>
          
          <div className="inputContainer">
            <svg className="inputIcon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
